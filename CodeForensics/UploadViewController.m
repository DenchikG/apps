...
//it is a main function,thats where the code started to 
...
@end//end of interface file

@implementation UploadViewController//implementation file ,thats where we write and execute the code
...
- (IBAction)performLargeUpload:(id)sender
{
    ...
    //entering a class data with the name of ''data''
