...
-(void)showWinner
{
    ...
    judge *judgeOne=[[judge alloc]init];
    computerWon=[judgeOne didComputerWin:computerHandLabel.text vs:playerHandLabel.text];
...
-(void)countDown
{
    ...
    if (count == 0) {
        ...
        //[generator generateComputerHand];
        computerHandLabel.text=[generator generateComputerHand];
    }
}
